...
```yaml
whoami: Mohammad Hosein
role: Full-Stack Developer · AI/ML Explorer · Software Engineering Student
focus:
  - 🔭 Building full-stack apps with React, Next.js, Node.js, Django & REST APIs
  - 🧠 Exploring machine learning, deep learning, explainable AI & reproducible ML workflows
  - 📱 Developing cross-platform mobile apps with Flutter
  - 🧩 Obsessed with clean code, scalable architecture & practical problem-solving
  - 🌱 Leveling up in MLOps, DevOps, deployment & production-ready systems
...
<img src="https://skillicons.dev/icons?i=js,ts,python,java,html,css&theme=dark" alt="JavaScript, TypeScript, Python, Java, HTML, CSS" />
...
<img src="https://skillicons.dev/icons?i=nodejs,express,django,mysql&theme=dark" alt="Node.js, Express, Django, MySQL" />

**Tools & Platforms**

<img src="https://skillicons.dev/icons?i=git,github,docker,linux,nginx,vscode&theme=dark" alt="Git, GitHub, Docker, Linux, Nginx, VS Code" />
...
I'm always interested in learning, collaborating, and turning useful ideas into working software. If you have a project, an opportunity, or simply want to talk tech — reach out.
